...
public class Bird {
    ...
    Bird (Resources res) {
        ...
        bird1 = BitmapFactory.decodeResource(res, R.drawable.bird);
        bird2 = BitmapFactory.decodeResource(res, R.drawable.bird);
        bird3 = BitmapFactory.decodeResource(res, R.drawable.bird);
        bird4 = BitmapFactory.decodeResource(res, R.drawable.bird);
